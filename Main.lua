...
function Library:Row(Parent, Args, Hidden)
    ...
    if Desc then
        ...
        Footer_1.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.SemiBold, Enum.FontStyle.Normal)
...
function Library:Window(Info)
    ...
    local Senzy = Instance.new('ScreenGui') do
        ...
        Layers2_1.ImageContent = Content.fromUri("rbxassetid://105837725217811")
        ...
        Layers1_1.ImageContent = Content.fromUri("rbxassetid://140229099079933")
    ...
    function Window:MakeTab(Info)
        ...
        local NewTab = Instance.new("Frame") do
            ...
            Icon_1.ImageContent = Content.fromUri("rbxassetid://130970470497096")
        ...
        function Tab:Section(Text)
            ...
            Section_1.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.SemiBold, Enum.FontStyle.Normal)
